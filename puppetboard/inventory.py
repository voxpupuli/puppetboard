...
from pypuppetdb.QueryBuilder import AndOperator, OrOperator, EqualsOperator

import puppetboard.facts
from puppetboard.app import app, check_env
...
def inventory_ajax(env):
    ...
    facts = puppetboard.facts.facts(query=query)
