...
RESOURCES_STATS_ENABLED = coerce_bool(os.getenv('RESOURCES_STATS_ENABLED'), True)

NODES_STATUS_DETAIL_ENABLED = coerce_bool(os.getenv('NODES_STATUS_DETAIL_ENABLED'), True)
